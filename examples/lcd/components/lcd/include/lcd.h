...
/**
 * @brief Simple routine to generate some patterns and send them to the LCD. Don't expect anything too 
 * impressive. Because the SPI driver handles transactions in the background, we can calculate the next line
 * while the previous one is being sent. 
 *
 * @param spi Changes the image data using the device handle.
 */
