...
static const media_key_mapping_t extended_media_key_map[] = {
    ...
    {KC_MEDIA_PREV_TRACK,  HID_USAGE_CONSUMER_SCAN_PREVIOUS},
    {KC_MEDIA_NEXT_TRACK,  HID_USAGE_CONSUMER_SCAN_NEXT},
    ...
    {KC_MEDIA_FAST_FORWARD, HID_USAGE_CONSUMER_SCAN_NEXT},
    {KC_MEDIA_REWIND,      HID_USAGE_CONSUMER_SCAN_PREVIOUS},
