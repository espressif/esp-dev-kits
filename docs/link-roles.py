...
def setup(app):
    ...
    baseurl = 'https://github.com/espressif/esp-dev-kits'
    app.add_role('dev-kits', autolink('{}/tree/{}/%s'.format(baseurl, rev)))
    app.add_role('dev-kits_file', autolink('{}/blob/{}/%s'.format(baseurl, rev)))
    app.add_role('dev-kits_raw', autolink('{}/raw/{}/%s'.format(baseurl, rev)))
