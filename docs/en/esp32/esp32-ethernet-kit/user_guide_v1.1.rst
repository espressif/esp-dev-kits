...
To implement this option, users need to remove or add some RC components on the board. For details please refer to `ESP32-Ethernet-Kit v1.1 Ethernet board (A) schematic`_, sheet 2, location U2.
