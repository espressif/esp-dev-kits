...
Older version: :doc:`user_guide_v1.2`
...
.. list-table::
   ...
   * - JTAG Switch
     - Switch to ON to enable connection between ESP32-S2 and FT2232; JTAG debugging will then be possible using USB-UART/JTAG Port. See also `JTAG Debugging <https://docs.espressif.com/projects/esp-idf/en/latest/esp32s2/api-guides/jtag-debugging/index.html>`_.
   * - Breakout Header 2
...
Also, all extension boards and the `JTAG interface <https://docs.espressif.com/projects/esp-idf/en/latest/esp32s2/api-guides/jtag-debugging/tips-and-quirks.html#jtag-debugging-tip-jtag-pins-reconfigured>`_ share the same pins IO39, IO40, IO41 and IO42. For this reason, the following may disturb the JTAG operation:
...
:doc:`Initial release <user_guide_v1.2>`
...
- `JTAG Debugging <https://docs.espressif.com/projects/esp-idf/en/latest/esp32s2/api-guides/jtag-debugging/index.html>`_
