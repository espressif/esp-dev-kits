...
.. figure:: ../../_static/esp32-p4x-c5-function-ev-board/esp32-p4x-c5-function-ev-board-isometric.png
    :align: center
...
.. figure:: ../../_static/esp32-p4x-c5-function-ev-board/esp32-p4x-c5-function-ev-board-block-diagram.png
    :align: center
    :width: 100%
...
.. figure:: ../../_static/esp32-p4x-c5-function-ev-board/esp32-p4x-c5-function-ev-board-front.png
    :align: center
    :width: 100%
...
.. figure:: ../../_static/esp32-p4x-c5-function-ev-board/esp32-p4x-c5-function-ev-board-back.png
    :align: center
    :width: 90%
...
- :project:`ESP_Brookesia Phone <examples/esp32-p4-function-ev-board/examples/esp_brookesia_phone>` - Demonstrates an Android-like interface with multiple applications using ESP_Brookesia, utilizing MIPI-DSI, MIPI-CSI, ESP32-C5, SD card, and audio interfaces on the development board, providing a basis for efficient multimedia application development.
