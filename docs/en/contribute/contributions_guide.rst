...
Contributions to esp-dev-kits - fixing bugs, adding features, adding documentation - are welcome. We accept contributions via `Github Pull Requests <https://help.github.com/articles/about-pull-requests>`_.
...
* Does any new code conform to the esp-dev-kits : :doc:`Style Guide <style-guide>` ?
