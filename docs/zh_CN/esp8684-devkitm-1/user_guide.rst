...
下表列出了开发板两侧排针（J1 和 J3）的 **名称** 和 **功能**，排针的名称如图 :ref:`user-guide-esp8684-devkitm-1-v1.1-board-front` 所示，排针的序号与 `ESP8684-DevKitM-1 原理图`_ (PDF) 一致。
...
.. _ESP8684-DevKitM-1 原理图: https://dl.espressif.com/dl/schematics/esp8684-devkitm-1-schematics_V1.1.pdf
.. _ESP8684-DevKitM-1 PCB 布局图: https://dl.espressif.com/dl/schematics/esp8684-devkitm-1-pcb-layout_V1.1.pdf
.. _ESP8684-DevKitM-1 尺寸图: https://dl.espressif.com/dl/schematics/esp8684-devkitm-1-dimensions_V1.1.pdf
.. _ESP8684-DevKitM-1 尺寸图源文件: https://dl.espressif.com/dl/schematics/esp8684-devkitm-1-dimensions_source_V1.1.dxf
