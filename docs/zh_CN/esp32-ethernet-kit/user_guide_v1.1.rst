...
.. figure:: ../../_static/esp32-ethernet-kit/esp32-ethernet-kit-v1.1.png
    :align: center
...
.. figure:: ../../_static/esp32-ethernet-kit/esp32-ethernet-kit-v1.1-block-diagram.png
    :align: center
    :scale: 60%
...
.. figure:: ../../_static/esp32-ethernet-kit/esp32-ethernet-kit-a-v1.1-layout.png
    :align: center
    :scale: 80%
...
.. list-table:: 表格2  PoE 子板（B 板）
  ...
  * - 主要组件
    - 基本介绍
  * - A 板连接器
    - 4 个排针（左侧）和排母（右侧），用于将 PoE 子板（B 板）连接至 :ref:`以太网母板（A 板）<get-started-esp32-ethernet-kit-a-v1.1-layout>`。左侧的管脚接受来自 PoE 交换机的电源。右侧的管脚为 以太网母板（A 板）提供 5 V 电源。
  * - 外部电源终端
...
.. figure:: ../../_static/esp32-ethernet-kit/esp32-ethernet-kit-rmii-clk-from-phy.png
    :align: center
    :scale: 80%
    :alt: PHY 侧提供 RMII 时钟
    :figclass: align-center
...
.. figure:: ../../_static/esp32-ethernet-kit/esp32-ethernet-kit-rmii-clk-to-phy.png
    :align: center
    :scale: 80%
...
要实现此选项，用户需要在板子上移除或添加一些阻容元器件。有关详细信息，请参见 `ESP32-Ethernet-Kit v1.1 以太网母板（A 板）原理图`_，第 2 页，位置 U2。
...
.. Note::
    ...
    除了 REF_CLK 之外，ESP32 的 *RMII 接口* 下的所有管脚分配都是固定的，不能通过 IO MUX 或 GPIO 矩阵进行更改。
...
.. csv-table::
    :header: ESP32-WROVER-B,IP101GRI,UART,JTAG,GPIO,备注
...
在完成开发环境设置和开发板测试后，即可配置并烧录 `ethernet/basic <https://github.com/espressif/esp-idf/tree/af25eb44/examples/ethernet/basic>`_ 示例。本示例专门用于测试以太网功能，支持不同 PHY，包括 :ref:`ESP32-Ethernet-Kit v1.1 开发板 <get-started-esp32-ethernet-kit-v1.1>` 使用的 **IP101GRI** 。
