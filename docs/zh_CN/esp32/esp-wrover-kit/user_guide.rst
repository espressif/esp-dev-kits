...
* `板上 LCD 示例 <https://github.com/espressif/esp-idf/tree/v5.3/examples/peripherals/spi_master/lcd>`_
* `SD 卡槽示例 <https://github.com/espressif/esp-idf/tree/v5.3/examples/storage/sd_card>`_
* `摄像头示例 <https://github.com/espressif/esp32-camera>`_
