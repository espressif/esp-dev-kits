...
- 2023 年 2 月当月或之后生产的开发板（生产工单号为 PW-2023-02-0139），J5 排针由直针改为弯针。

.. 注解::

  批量订单的生产工单号可在大纸板箱包装的物料标签中找到。
...
* `ESP32-C6-DevKitC-1 原理图 <../../_static/esp32-c6-devkitc-1/schematics/esp32-c6-devkitc-1-schematics_v1.2.pdf>`_ (PDF)
