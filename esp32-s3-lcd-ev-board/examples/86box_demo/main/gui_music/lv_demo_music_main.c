...
static lv_obj_t *create_return_btn(lv_obj_t *parent);
...
lv_obj_t *_lv_demo_music_main_create(lv_obj_t *parent)
{
    ...
    lv_obj_t *btn_back = create_return_btn(cont);
...
static lv_obj_t *create_return_btn(lv_obj_t *parent)
{
    lv_obj_t *cont = lv_imgbtn_create(parent);
    lv_imgbtn_set_src(cont, LV_IMGBTN_STATE_RELEASED, NULL, &img_return2, NULL);
    lv_imgbtn_set_src(cont, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &img_return2, NULL);
    lv_obj_add_flag(cont, LV_OBJ_FLAG_CHECKABLE);
    lv_obj_add_flag(cont, LV_OBJ_FLAG_CLICKABLE);

    lv_obj_add_event_cb(cont, play_event_return_cb, LV_EVENT_CLICKED, NULL);
    lv_obj_set_size(cont, img_return2.header.w, 80);
