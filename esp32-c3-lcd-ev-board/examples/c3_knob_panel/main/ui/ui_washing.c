...
static const wash_cycle_t wash_cycle[FUNC_NUM] = {
    {&img_washing_stand, 58},
    {&img_washing_shirt, 68},
    {&img_washing_underwear, 82},
};
...
static uint32_t wash_time_left;
...
void ui_washing_init(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_text_font(label_leftTimeH, &font_cn_48, 0);
    ...
    lv_obj_set_style_text_font(label_leftTimeL, &font_cn_48, 0);
    ...
    lv_obj_set_style_text_font(label_leftTime_unit, &font_cn_48, 0);
    ...
    //lv_obj_set_width(label_info, 200);
    ...
    for (size_t i = 0; i < FUNC_NUM; i++) {
        ...
        lv_img_set_src(img_funcs[i], wash_cycle[i].wash_funcs);
        x = 40;
        y = (i - 1) * 40;
